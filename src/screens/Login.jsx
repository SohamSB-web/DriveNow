      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-8 relative z-10">
        ...
        >
          ...
          <form className="space-y-5" onSubmit={(e) => {
            ...
            <button type="submit" className="w-full btn-primary py-3.5 rounded-2xl text-sm font-bold tracking-wide mt-2">
              Sign up
            </button>
            ...
            <button type="button" className="w-full btn-secondary py-3.5 rounded-2xl text-sm font-bold tracking-wide flex items-center justify-center gap-3">
          ...
          <p className="text-center text-sm text-gray-500 mt-8 font-medium">
            Already have an account? <a href="#" className="text-blue-500 hover:text-blue-400 transition-colors">Login</a>
          </p>
        </motion.div>
